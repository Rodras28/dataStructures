...
public class ListInArray<E> implements List<E> {
     ...
     * @throws NoSuchElementException - if size() == 0
     * Time complexity: O(1) best and O(n) worst case.
     */
    ...
    public E remove(int position) {
        ...
        if(indexOf(elems[position]) == 0) {
            return removeFirst();
        } else if(indexOf(elems[position]) == counter - 1) {
            return removeLast();
        } else {
            E toReturn = elems[position];
